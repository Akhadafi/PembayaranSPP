...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jan 2022 pada 03.57
...
(1, 1, '001', '2022-01-15', 'januari', '2022', 1, 110000);
...
INSERT INTO `petugas` (`id_petugas`, `username`, `password`, `nama_petugas`, `level`, `alamat`, `no_telp`, `jenis_kelamin`) VALUES
(1, 'eve01', 'eve123', 'eve', 'petugas', 'payakumbuh', '0800000000', 'laki-laki');
...
('001', '01', 'nana', 1, 'Payakumbuh', '0800000000', 1, 'perempuan');
