<div class="d-flex container-fluid fixed-top flex-column flex-md-row align-items-center mb-4 border-bottom border-top" style="background-color:black;">
    ...
    <nav class="d-inline-flex mt-md-0 ms-md-auto">
        ...
        <a class="nav-link m-auto text-light text-decoration-none" href="../dashboard/">Dashboard</a>
        ...
        <ul class="dropdown-menu mt-2 justify-content-end" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="dropdown-item" href="../petugas/?search">Petugas</a>
            </li>
        </ul>
        <!--  -->
    </nav>
